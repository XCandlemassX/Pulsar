...
namespace Pulsar.Server.Forms
{
    ...
    {
        private readonly string _repositoryUrl = @"https://github.com/Quasar-Continuation/Pulsar-Lite";
        ...
        private async Task<string> FetchContributors()
        {
            using (WebClient client = new WebClient())
            {
                ...
                string apiUrl = "https://api.github.com/repos/Quasar-Continuation/Pulsar-Lite/contributors";
